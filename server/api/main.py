...
from server.logic import _list_containers, _get_container_logs, _system_health
from server.api.schemas import ContainerListResponse, ContainerLogsResponse, SystemHealthResponse
...
@app.get("/system_health", response_model=SystemHealthResponse)
